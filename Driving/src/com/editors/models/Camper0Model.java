...
public class Camper0Model extends PickupModel {
    ...
    public Camper0Model(double dx, double dy, double dz,
            double dxFront, double dyfront,
            double dzFront, double dxRoof,
            double dyRoof, double dzRoof,
    ...
    protected int buildWagonFaces(int counter, int nzWagon) {
        ...
        faces[counter++] = buildFace(Renderer3D.CAR_BOTTOM, wagon2[0][0], wagon2[0][3], wagon2[0][2], wagon2[0][1], wa[0]);
