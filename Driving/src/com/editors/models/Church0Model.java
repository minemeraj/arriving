...
public class Church0Model extends MeshModel{
	...
	private int buildCross(int counter, BPoint[][][] mainCross, BPoint[][][] crossRoof) {
		...
		//roof, to test later
		//faces[counter++]=buildFace(Renderer3D.CAR_TOP, mainCross[1][0][1],mainCross[1][0][2],mainCross[1][1][2],mainCross[1][1][1], c0, c1, c2, c3);
		//faces[counter++]=buildFace(Renderer3D.CAR_TOP, mainCross[2][0][1],mainCross[1][0][2],mainCross[1][1][2],mainCross[2][1][1], c0, c1, c2, c3);
