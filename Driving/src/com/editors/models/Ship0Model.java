...
public class Ship0Model extends MeshModel{
	...
	public void initMesh() {
		...
		Segments s1=new Segments(x0,y0,z0+dz,dx,dy*0.25,50);
		...
		//build the main deck		
		for (int i = 0; i < ny-1; i++) {
			faces[counter++]=buildFace(Renderer3D.CAR_TOP, hull[i][0],hull[i][nx-1],hull[i+1][nx-1],hull[i][0], 4,5,6,7);
		}
