...
public class Car0Model extends MeshModel {
    ...
    private int buildTexture() {
        ...
        for (int k = 0; k < numSections - 1; k++) {
            ...
            double dSidePl=Math.sqrt(dz*(z2pl-z1pl)*dz*(z2pl-z1pl)+dx*(x2pl-x1pl)*dx*(x2pl-x1pl));
            double dRoofX=dx*x2;
            ...
            for (int p0 = 0; p0 < nBasePoints; p0++) {
                ...
                if (p0 == 0) {
                    ...
                    addTPoint(x+ dz * z1, y, 0);
                    addTPoint(x+ dz * z1 + dz * dSide, y, 0);
                    addTPoint(x+ dz * z1pl + dz * dSidePl, y + incrementY, 0);
                    addTPoint(x+ dz * z1pl + dz * z1pl, y + incrementY, 0);
                    x+=dz;
                    ...
                    addTPoint(x + dz * (1.0 - dSide), y, 0);
                    addTPoint(x + dz * (1.0 - z1), y, 0);
                    addTPoint(x + dz * (1.0 - z1pl), y + incrementY, 0);
                    addTPoint(x + dz * (1.0 - dSidePl), y + incrementY, 0);
