...
public abstract class MeshModel {
    ...
    void fillTexturePolygon(Graphics2D graphics, int... indexes) {
        ...
        Polygon3D p = new Polygon3D(indexes.length);
    ...
    /**
     * Add a Texture isosceles trapezium starting from the x,y point, moving dx,
     * dz1 ,dy
     *
     * @param x
     * @param y
    ...
    protected void buildWheelTexturesWithCenter(double x,double y,double xCenter, double yCenter, double radius,int rays_number,double shift_angle) {
        addTPoint(x + xCenter, y + yCenter, 0);
        buildWheelTextures(x,y,xCenter, yCenter, radius,rays_number,shift_angle);
    }

    protected void buildWheelTextures(double x,double y,double xCenter, double yCenter, double radius,int rays_number,double shift_angle) {

        double dTeta=2*Math.PI/rays_number;
