 ...
 *
 */
public class CarTransporterModel extends MeshModel {
    ...
    public static final String NAME = "Car transporter";

    public CarTransporterModel(double dx, double dy, double dz, double dxFront, double dyfront, double dzFront, double dxRoof,
