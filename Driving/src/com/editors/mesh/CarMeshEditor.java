...
public class CarMeshEditor extends MeshModelEditor implements KeyListener, ItemListener {
    ...
    public void initMesh() {
        ...
        if (val == CAR0) {
            ...
            meshModel = new Jeep0Model(dx, dy, dz, dxf, dyf, dzf, dxRoof, dyRoof, dzRoof, wheelRadius, wheelWidth,
                    wheelRays);
        } else if (val == BEETLE) {
            meshModel = new BeetleModel(dx, dy, dz);
        } else if (val == CAMPER0) {
            meshModel = new Camper0Model(dx, dy, dz, dxf, dyf, dzf, dxRoof, dyRoof, dzRoof,rearOverhang,frontOverhang,wheelRadius, wheelWidth,
                    wheelRays);
        } else if (val == TRUCK0) {
            meshModel = new Truck0Model(dx, dy, dz, dxf, dyf, dzf, dxRoof, dyRoof, dzRoof, wheelRadius, wheelWidth,
                    wheelRays);
        } else if (val == TANKTRUCK0) {
            meshModel = new TankTruck0Model(dx, dy, dz, dxf, dyf, dzf, dxRoof, dyRoof, dzRoof, wheelRadius, wheelWidth,
                    wheelRays);
        } else if (val == TRUNKSTRUCK) {
            meshModel = new TrunksTruck0Model(dx, dy, dz, dxf, dyf, dzf, dxRoof, dyRoof, dzRoof, wheelRadius, wheelWidth,
                    wheelRays);
        }  else if (val == AUTOBUS) {
            meshModel = new Autobus0Model(dx, dy, dz, dxf, dyf, dzf, dxRoof, dyRoof, dzRoof, wheelRadius, wheelWidth,
                    wheelRays);
        } else if (val == ATEAMVAN) {
            meshModel = new ATeamVanModel(dx, dy, dz, dxf, dyf, dzf, dxRoof, dyRoof, dzRoof, wheelRadius, wheelWidth,
                    wheelRays);
        } else if (val == PICKUP) {
            meshModel = new PickupModel(dx, dy, dz, dxf, dyf, dzf, dxRoof, dyRoof, dzRoof, wheelRadius, wheelWidth,
                    wheelRays);
        } else if (val == CARTRANSPORTER) {
            meshModel = new CarTransporterModel(dx, dy, dz, dxf, dyf, dzf, dxRoof, dyRoof, dzRoof, wheelRadius, wheelWidth,
                    wheelRays);
        }
        else if (val == SHIP0) {
            ...
            meshModel = new SteamLocomotive0Model(dx, dy, dz, dxf, dyf, dzf, dxRoof, dyRoof, dzRoof, wheelRadius, wheelWidth,
                    wheelRays);
            ...
            meshModel = new Tractor0Model(dx, dy, dz, dxf, dyf, dzf, dxr, dyr, dzr, dxRoof, dyRoof, dzRoof, wheelRadius, wheelWidth, wheelRays);
        } else {
            meshModel = new Car0Model(dx, dy, dz);
        }
    ...
    public void itemStateChanged(ItemEvent arg0) {
        ...
        if (obj == chooseObject) {
            ...
            if (CAR0 == val) {
                ...
                setRightData(94, 319, 22, // dx, dy, dz
                        94, 61, 118, // dxFront, dyFront, dzFront
                        0, 0, 0, // dxRear, dyRear, dzRear
                        111, 319, 116, // dxRoof, dyRoof, dzRoof
                        0, 0, // rearOverhang, frontOverhang
