...
public class CarMeshEditor extends MeshModelEditor implements KeyListener, ItemListener {
    ...
    public void initMesh() {
        ...
        if (val == CAR0) {
            ...
            meshModel = new StarShip0Model(dx, dy, dz, dxf, dyf, dzf, dxr, dyr, dzr, dxRoof, dyRoof, dzRoof,rearOverhang,
                    frontOverhang, rearOverhang1, frontOverhang1);
        } else if (val == AIRPLANE0) {

            meshModel = new Airplane0Model(dx, dy, dz, dxf, dyf, dzf, dxr, dyr, dzr, dxRoof, dyRoof, dzRoof,rearOverhang,
                    frontOverhang, rearOverhang1, frontOverhang1);
        } else if (val == FIGHTER_AIRCRAFT0) {

            meshModel = new FighterAircraft0Model(dx, dy, dz, dxf, dyf, dzf, dxr, dyr, dzr, dxRoof, dyRoof, dzRoof,rearOverhang,
                    frontOverhang, rearOverhang1, frontOverhang1);
        } else if (val == HELICOPTER) {
            meshModel = new Helicopter0Model(dx, dy, dz, dxf, dyf, dzf, dxr, dyr, dzr, dxRoof, dyRoof, dzRoof,rearOverhang,
                    frontOverhang, rearOverhang1, frontOverhang1);
        } else if (val == BYKE0) {
    ...
    public void itemStateChanged(ItemEvent arg0) {
        ...
        if (obj == chooseObject) {
            ...
            if (CAR0 == val) {
                ...
                setRightData(200, 600, 80, // dx, dy, dz
                        50, 600, 150, // dxFront, dyFront, dzFront
                        200, 150, 80, // dxRear, dyRear, dzRear
                        200, 250, 80, // dxRoof, dyRoof, dzRoof
                        40, 30, // rearOverhang, frontOverhang
                        0, 0, // rearOverhang1,frontOverhang1,
                        10, 150, 10// wheel_radius, wheel_width, wheel_rays
                        );
