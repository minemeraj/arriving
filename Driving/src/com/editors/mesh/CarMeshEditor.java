...
public class CarMeshEditor extends MeshModelEditor implements KeyListener, ItemListener {
	...
	public void initMesh() {
		...
		if (val == CAR0) {
			...
			meshModel = new Jeep0Model(dx, dy, dz, dxf, dyf, dzf, dxRoof, dyRoof, dzRoof, rearOverhang, frontOverhang,
			...
			meshModel = new Truck0Model(dx, dy, dz, dxf, dyf, dzf, dxRoof, dyRoof, dzRoof, rearOverhang, frontOverhang,
					rearOverhang1, frontOverhang1, wheelRadius, wheelWidth, wheelRays);
		} else if (val == TANKTRUCK0) {
			meshModel = new TankTruck0Model(dx, dy, dz, dxf, dyf, dzf, dxRoof, dyRoof, dzRoof, rearOverhang,
					frontOverhang, rearOverhang1, frontOverhang1, wheelRadius, wheelWidth, wheelRays);
		} else if (val == TRUNKSTRUCK) {
			meshModel = new TrunksTruck0Model(dx, dy, dz, dxf, dyf, dzf, dxRoof, dyRoof, dzRoof, rearOverhang,
					frontOverhang, rearOverhang1, frontOverhang1, wheelRadius, wheelWidth, wheelRays);
		} else if (val == AUTOBUS) {
			meshModel = new Autobus0Model(dx, dy, dz, dxf, dyf, dzf, dxRoof, dyRoof, dzRoof, rearOverhang,
					frontOverhang, rearOverhang1, frontOverhang1, wheelRadius, wheelWidth, wheelRays);
		} else if (val == ATEAMVAN) {
			meshModel = new ATeamVanModel(dx, dy, dz, dxf, dyf, dzf, dxRoof, dyRoof, dzRoof, rearOverhang,
					frontOverhang, rearOverhang1, frontOverhang1, wheelRadius, wheelWidth, wheelRays);
		} else if (val == PICKUP) {
			meshModel = new PickupModel(dx, dy, dz, dxf, dyf, dzf, dxRoof, dyRoof, dzRoof, rearOverhang, frontOverhang,
					rearOverhang1, frontOverhang1, wheelRadius, wheelWidth, wheelRays);
