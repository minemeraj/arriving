...
public class CarMeshEditor extends MeshModelEditor implements KeyListener, ItemListener {
	...
	public void initMesh() {
		...
		if (val == CAR0) {
			...
			meshModel = new Camper0Model(dx, dy, dz, dxf, dyf, dzf, dxRoof, dyRoof, dzRoof, wheelRadius, wheelWidth,
					wheelRays);
		} else if (val == TRUCK0) {
			...
			meshModel = new F10Model(dx, dy, dz, dxf, dyf, dzf, dxr, dyr, dzr, dxRoof, dyRoof, dzRoof, wheelRadius,
					wheelWidth, wheelRays);
		} else if (val == TANK0) {
			...
			meshModel = new Tractor0Model(dx, dy, dz, dxf, dyf, dzf, dxr, dyr, dzr, dxRoof, dyRoof, dzRoof);
		} else {
			meshModel = new Car0Model(dx, dy, dz);
		}
