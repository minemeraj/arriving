...
public class CarMeshEditor extends MeshModelEditor implements KeyListener, ItemListener {
	...
	public void initMesh() {
		...
		if (val == CAR0) {
			...
			meshModel = new Camper0Model(dx, dy, dz, dxf, dyf, dzf, dxRoof, dyRoof, dzRoof, rearOverhang, frontOverhang,
			...
			meshModel = new TrunksTruck0Model(dx, dy, dz, dxf, dyf, dzf, dxRoof, dyRoof, dzRoof, wheelRadius,
