...
abstract class MeshModelEditor extends JFrame implements ActionListener, MenuListener{
    ...
    abstract public void initMesh();

    abstract public void printTexture(File file);
    ...
    abstract public void printMeshData(PrintWriter pw);
