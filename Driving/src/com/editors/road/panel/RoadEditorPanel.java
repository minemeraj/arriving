...
public abstract class RoadEditorPanel extends JPanel {
    ...
    public abstract HashMap<Integer,Boolean> pickUpPointsWithFastCircle(PolygonMesh mesh);

    public abstract Polygon3D getInterpolatingPoygonFromPoint(PolygonMesh mesh,double x,double y);
