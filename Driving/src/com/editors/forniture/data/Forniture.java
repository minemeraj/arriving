...
public class Forniture extends CustomData{
	...
	private PolygonMesh buildToiletMesh() { 
		...
		body[0][1][0]=addBPoint(-0.29,0.284,0.0,h0);
		body[1][1][0]=addBPoint(-0.217,0.284,0.0,h0);
		body[2][1][0]=addBPoint(-0.145,0.284,0.0,h0);
		body[3][1][0]=addBPoint(-0.073,0.284,0.0,h0);
		body[4][1][0]=addBPoint(0.0,0.284,0.0,h0);
		body[5][1][0]=addBPoint(0.073,0.284,0.0,h0);
		body[6][1][0]=addBPoint(0.145,0.284,0.0,h0);
		body[7][1][0]=addBPoint(0.217,0.284,0.0,h0);
		body[8][1][0]=addBPoint(0.29,0.284,0.0,h0);
		body[0][1][1]=addBPoint(-0.247,0.262,0.248,h0);		
		body[8][1][1]=addBPoint(0.247,0.262,0.248,h0);
		body[0][1][2]=addBPoint(-0.228,0.222,0.416,h0);		
		body[8][1][2]=addBPoint(0.228,0.222,0.416,h0);
		body[0][1][3]=addBPoint(-0.216,0.203,0.478,h0);		
		body[8][1][3]=addBPoint(0.216,0.203,0.478,h0);
		body[0][1][4]=addBPoint(-0.302,0.199,0.565,h0);		
		body[8][1][4]=addBPoint(0.302,0.199,0.565,h0);
		body[0][1][5]=addBPoint(-0.401,0.186,0.671,h0);		
		body[8][1][5]=addBPoint(0.401,0.186,0.671,h0);
		body[0][1][6]=addBPoint(-0.451,0.167,0.75,h0);		
		body[8][1][6]=addBPoint(0.451,0.167,0.75,h0);
		body[0][1][7]=addBPoint(-0.481,0.144,0.875,h0);
		body[8][1][7]=addBPoint(0.481,0.144,0.875,h0);
		body[0][1][8]=addBPoint(-0.5,0.125,1.0,h0);
		body[1][1][8]=addBPoint(-0.375,0.125,1.0,h0);
		body[2][1][8]=addBPoint(-0.25,0.125,1.0,h0);
		body[3][1][8]=addBPoint(-0.125,0.125,1.0,h0);
		body[4][1][8]=addBPoint(0.0,0.125,1.0,h0);
		body[5][1][8]=addBPoint(0.125,0.125,1.0,h0);
		body[6][1][8]=addBPoint(0.25,0.125,1.0,h0);
		body[7][1][8]=addBPoint(0.375,0.125,1.0,h0);
		body[8][1][8]=addBPoint(0.5,0.125,1.0,h0);

		body[0][2][0]=addBPoint(-0.29,0.366,0.0,h0);
		body[1][2][0]=addBPoint(-0.217,0.366,0.0,h0);
		body[2][2][0]=addBPoint(-0.145,0.366,0.0,h0);
		body[3][2][0]=addBPoint(-0.073,0.366,0.0,h0);
		body[4][2][0]=addBPoint(0.0,0.366,0.0,h0);
		body[5][2][0]=addBPoint(0.073,0.366,0.0,h0);
		body[6][2][0]=addBPoint(0.145,0.366,0.0,h0);
		body[7][2][0]=addBPoint(0.217,0.366,0.0,h0);
		body[8][2][0]=addBPoint(0.29,0.366,0.0,h0);
		body[0][2][1]=addBPoint(-0.247,0.343,0.248,h0);	
		body[8][2][1]=addBPoint(0.247,0.343,0.248,h0);
		body[0][2][2]=addBPoint(-0.228,0.307,0.416,h0);	
		body[8][2][2]=addBPoint(0.228,0.307,0.416,h0);
		body[0][2][3]=addBPoint(-0.216,0.29,0.478,h0);	
		body[8][2][3]=addBPoint(0.216,0.29,0.478,h0);
		body[0][2][4]=addBPoint(-0.302,0.297,0.565,h0);	
		body[8][2][4]=addBPoint(0.302,0.297,0.565,h0);
		body[0][2][5]=addBPoint(-0.401,0.293,0.671,h0);	
		body[8][2][5]=addBPoint(0.401,0.293,0.671,h0);
		body[0][2][6]=addBPoint(-0.451,0.281,0.783,h0);	
		body[8][2][6]=addBPoint(0.451,0.281,0.783,h0);
		body[0][2][7]=addBPoint(-0.481,0.263,0.907,h0);		
		body[8][2][7]=addBPoint(0.481,0.263,0.907,h0);
		body[0][2][8]=addBPoint(-0.5,0.25,1.0,h0);
		body[1][2][8]=addBPoint(-0.375,0.25,1.0,h0);
		body[2][2][8]=addBPoint(-0.25,0.25,1.0,h0);
		body[3][2][8]=addBPoint(-0.125,0.25,1.0,h0);
		body[4][2][8]=addBPoint(0.0,0.25,1.0,h0);
		body[5][2][8]=addBPoint(0.125,0.25,1.0,h0);
		body[6][2][8]=addBPoint(0.25,0.25,1.0,h0);
		body[7][2][8]=addBPoint(0.375,0.25,1.0,h0);
		body[8][2][8]=addBPoint(0.5,0.25,1.0,h0);

		body[0][3][0]=addBPoint(-0.29,0.447,0.0,h0);
		body[1][3][0]=addBPoint(-0.217,0.447,0.0,h0);
		body[2][3][0]=addBPoint(-0.145,0.447,0.0,h0);
		body[3][3][0]=addBPoint(-0.073,0.447,0.0,h0);
		body[4][3][0]=addBPoint(0.0,0.447,0.0,h0);
		body[5][3][0]=addBPoint(0.073,0.447,0.0,h0);
		body[6][3][0]=addBPoint(0.145,0.447,0.0,h0);
		body[7][3][0]=addBPoint(0.217,0.447,0.0,h0);
		body[8][3][0]=addBPoint(0.29,0.447,0.0,h0);
		body[0][3][1]=addBPoint(-0.247,0.424,0.248,h0);		
		body[8][3][1]=addBPoint(0.247,0.424,0.248,h0);
		body[0][3][2]=addBPoint(-0.228,0.392,0.416,h0);	
		body[8][3][2]=addBPoint(0.228,0.392,0.416,h0);
		body[0][3][3]=addBPoint(-0.216,0.377,0.478,h0);		
		body[8][3][3]=addBPoint(0.216,0.377,0.478,h0);
		body[0][3][4]=addBPoint(-0.302,0.395,0.565,h0);		
		body[8][3][4]=addBPoint(0.302,0.395,0.565,h0);
		body[0][3][5]=addBPoint(-0.401,0.4,0.671,h0);	
		body[8][3][5]=addBPoint(0.401,0.4,0.671,h0);
		body[0][3][6]=addBPoint(-0.451,0.394,0.783,h0);	
		body[8][3][6]=addBPoint(0.451,0.394,0.783,h0);
		body[0][3][7]=addBPoint(-0.481,0.381,0.907,h0);
		body[8][3][7]=addBPoint(0.481,0.381,0.907,h0);
		body[0][3][8]=addBPoint(-0.5,0.375,1.0,h0);
		body[1][3][8]=addBPoint(-0.375,0.375,1.0,h0);
		body[2][3][8]=addBPoint(-0.25,0.375,1.0,h0);
		body[3][3][8]=addBPoint(-0.125,0.375,1.0,h0);
		body[4][3][8]=addBPoint(0.0,0.375,1.0,h0);
		body[5][3][8]=addBPoint(0.125,0.375,1.0,h0);
		body[6][3][8]=addBPoint(0.25,0.375,1.0,h0);
		body[7][3][8]=addBPoint(0.375,0.375,1.0,h0);
		body[8][3][8]=addBPoint(0.5,0.375,1.0,h0);

		body[0][4][0]=addBPoint(-0.29,0.529,0.0,h0);
		body[1][4][0]=addBPoint(-0.217,0.529,0.0,h0);
		body[2][4][0]=addBPoint(-0.145,0.529,0.0,h0);
		body[3][4][0]=addBPoint(-0.073,0.529,0.0,h0);
		body[4][4][0]=addBPoint(0.0,0.529,0.0,h0);
		body[5][4][0]=addBPoint(0.073,0.529,0.0,h0);
		body[6][4][0]=addBPoint(0.145,0.529,0.0,h0);
		body[7][4][0]=addBPoint(0.217,0.529,0.0,h0);
		body[8][4][0]=addBPoint(0.29,0.529,0.0,h0);
		body[0][4][1]=addBPoint(-0.247,0.506,0.248,h0);	
		body[8][4][1]=addBPoint(0.247,0.506,0.248,h0);
		body[0][4][2]=addBPoint(-0.228,0.477,0.416,h0);	
		body[8][4][2]=addBPoint(0.228,0.477,0.416,h0);
		body[0][4][3]=addBPoint(-0.216,0.464,0.478,h0);	
		body[8][4][3]=addBPoint(0.216,0.464,0.478,h0);
		body[0][4][4]=addBPoint(-0.302,0.493,0.565,h0);		
		body[8][4][4]=addBPoint(0.302,0.493,0.565,h0);
		body[0][4][5]=addBPoint(-0.401,0.507,0.671,h0);	
		body[8][4][5]=addBPoint(0.401,0.507,0.671,h0);
		body[0][4][6]=addBPoint(-0.451,0.507,0.783,h0);		
		body[8][4][6]=addBPoint(0.451,0.507,0.783,h0);
		body[0][4][7]=addBPoint(-0.481,0.5,0.907,h0);	
		body[8][4][7]=addBPoint(0.481,0.5,0.907,h0);
		body[0][4][8]=addBPoint(-0.5,0.5,1.0,h0);
		body[1][4][8]=addBPoint(-0.375,0.5,1.0,h0);
		body[2][4][8]=addBPoint(-0.25,0.5,1.0,h0);
		body[3][4][8]=addBPoint(-0.125,0.5,1.0,h0);
		body[4][4][8]=addBPoint(0.0,0.5,1.0,h0);
		body[5][4][8]=addBPoint(0.125,0.5,1.0,h0);
		body[6][4][8]=addBPoint(0.25,0.5,1.0,h0);
		body[7][4][8]=addBPoint(0.375,0.5,1.0,h0);
		body[8][4][8]=addBPoint(0.5,0.5,1.0,h0);

		body[0][5][0]=addBPoint(-0.29,0.611,0.0,h0);
		body[1][5][0]=addBPoint(-0.217,0.611,0.0,h0);
		body[2][5][0]=addBPoint(-0.145,0.611,0.0,h0);
		body[3][5][0]=addBPoint(-0.073,0.611,0.0,h0);
		body[4][5][0]=addBPoint(0.0,0.611,0.0,h0);
		body[5][5][0]=addBPoint(0.073,0.611,0.0,h0);
		body[6][5][0]=addBPoint(0.145,0.611,0.0,h0);
		body[7][5][0]=addBPoint(0.217,0.611,0.0,h0);
		body[8][5][0]=addBPoint(0.29,0.611,0.0,h0);
		body[0][5][1]=addBPoint(-0.247,0.587,0.248,h0);	
		body[8][5][1]=addBPoint(0.247,0.587,0.248,h0);
		body[0][5][2]=addBPoint(-0.228,0.561,0.416,h0);		
		body[8][5][2]=addBPoint(0.228,0.561,0.416,h0);
		body[0][5][3]=addBPoint(-0.216,0.551,0.478,h0);		
		body[8][5][3]=addBPoint(0.216,0.551,0.478,h0);
		body[0][5][4]=addBPoint(-0.302,0.59,0.565,h0);		
		body[8][5][4]=addBPoint(0.302,0.59,0.565,h0);
		body[0][5][5]=addBPoint(-0.401,0.614,0.671,h0);		
		body[8][5][5]=addBPoint(0.401,0.614,0.671,h0);
		body[0][5][6]=addBPoint(-0.451,0.62,0.783,h0);		
		body[8][5][6]=addBPoint(0.451,0.62,0.783,h0);
		body[0][5][7]=addBPoint(-0.481,0.619,0.907,h0);	
		body[8][5][7]=addBPoint(0.481,0.619,0.907,h0);
		body[0][5][8]=addBPoint(-0.5,0.625,1.0,h0);
		body[1][5][8]=addBPoint(-0.375,0.625,1.0,h0);
		body[2][5][8]=addBPoint(-0.25,0.625,1.0,h0);
		body[3][5][8]=addBPoint(-0.125,0.625,1.0,h0);
		body[4][5][8]=addBPoint(0.0,0.625,1.0,h0);
		body[5][5][8]=addBPoint(0.125,0.625,1.0,h0);
		body[6][5][8]=addBPoint(0.25,0.625,1.0,h0);
		body[7][5][8]=addBPoint(0.375,0.625,1.0,h0);
		body[8][5][8]=addBPoint(0.5,0.625,1.0,h0);

		body[0][6][0]=addBPoint(-0.29,0.692,0.0,h0);
		body[1][6][0]=addBPoint(-0.217,0.692,0.0,h0);
		body[2][6][0]=addBPoint(-0.145,0.692,0.0,h0);
		body[3][6][0]=addBPoint(-0.073,0.692,0.0,h0);
		body[4][6][0]=addBPoint(0.0,0.692,0.0,h0);
		body[5][6][0]=addBPoint(0.073,0.692,0.0,h0);
		body[6][6][0]=addBPoint(0.145,0.692,0.0,h0);
		body[7][6][0]=addBPoint(0.217,0.692,0.0,h0);
		body[8][6][0]=addBPoint(0.29,0.692,0.0,h0);
		body[0][6][1]=addBPoint(-0.247,0.668,0.248,h0);	
		body[8][6][1]=addBPoint(0.247,0.668,0.248,h0);
		body[0][6][2]=addBPoint(-0.228,0.646,0.416,h0);		
		body[8][6][2]=addBPoint(0.228,0.646,0.416,h0);
		body[0][6][3]=addBPoint(-0.216,0.638,0.478,h0);	
		body[8][6][3]=addBPoint(0.216,0.638,0.478,h0);
		body[0][6][4]=addBPoint(-0.302,0.688,0.565,h0);	
		body[8][6][4]=addBPoint(0.302,0.688,0.565,h0);
		body[0][6][5]=addBPoint(-0.401,0.721,0.671,h0);		
		body[8][6][5]=addBPoint(0.401,0.721,0.671,h0);
		body[0][6][6]=addBPoint(-0.451,0.734,0.783,h0);
		body[8][6][6]=addBPoint(0.451,0.734,0.783,h0);
		body[0][6][7]=addBPoint(-0.481,0.737,0.907,h0);	
		body[8][6][7]=addBPoint(0.481,0.737,0.907,h0);
		body[0][6][8]=addBPoint(-0.5,0.75,1.0,h0);
		body[1][6][8]=addBPoint(-0.375,0.75,1.0,h0);
		body[2][6][8]=addBPoint(-0.25,0.75,1.0,h0);
		body[3][6][8]=addBPoint(-0.125,0.75,1.0,h0);
		body[4][6][8]=addBPoint(0.0,0.75,1.0,h0);
		body[5][6][8]=addBPoint(0.125,0.75,1.0,h0);
		body[6][6][8]=addBPoint(0.25,0.75,1.0,h0);
		body[7][6][8]=addBPoint(0.375,0.75,1.0,h0);
		body[8][6][8]=addBPoint(0.5,0.75,1.0,h0);

		body[0][7][0]=addBPoint(-0.29,0.774,0.0,h0);
		body[1][7][0]=addBPoint(-0.217,0.774,0.0,h0);
		body[2][7][0]=addBPoint(-0.145,0.774,0.0,h0);
		body[3][7][0]=addBPoint(-0.073,0.774,0.0,h0);
		body[4][7][0]=addBPoint(0.0,0.774,0.0,h0);
		body[5][7][0]=addBPoint(0.073,0.774,0.0,h0);
		body[6][7][0]=addBPoint(0.145,0.774,0.0,h0);
		body[7][7][0]=addBPoint(0.217,0.774,0.0,h0);
		body[8][7][0]=addBPoint(0.29,0.774,0.0,h0);
		body[0][7][1]=addBPoint(-0.247,0.749,0.248,h0);		
		body[8][7][1]=addBPoint(0.247,0.749,0.248,h0);
		body[0][7][2]=addBPoint(-0.228,0.731,0.416,h0);		
		body[8][7][2]=addBPoint(0.228,0.731,0.416,h0);
		body[0][7][3]=addBPoint(-0.216,0.725,0.478,h0);		
		body[8][7][3]=addBPoint(0.216,0.725,0.478,h0);
		body[0][7][4]=addBPoint(-0.302,0.786,0.565,h0);	
		body[8][7][4]=addBPoint(0.302,0.786,0.565,h0);
		body[0][7][5]=addBPoint(-0.401,0.828,0.671,h0);		
		body[8][7][5]=addBPoint(0.401,0.828,0.671,h0);
		body[0][7][6]=addBPoint(-0.451,0.847,0.783,h0);	
		body[8][7][6]=addBPoint(0.451,0.847,0.783,h0);
		body[0][7][7]=addBPoint(-0.481,0.856,0.907,h0);
		body[8][7][7]=addBPoint(0.481,0.856,0.907,h0);
		body[0][7][8]=addBPoint(-0.5,0.875,1.0,h0);
		body[1][7][8]=addBPoint(-0.375,0.875,1.0,h0);
		body[2][7][8]=addBPoint(-0.25,0.875,1.0,h0);
		body[3][7][8]=addBPoint(-0.125,0.875,1.0,h0);
		body[4][7][8]=addBPoint(0.0,0.875,1.0,h0);
		body[5][7][8]=addBPoint(0.125,0.875,1.0,h0);
		body[6][7][8]=addBPoint(0.25,0.875,1.0,h0);
		body[7][7][8]=addBPoint(0.375,0.875,1.0,h0);
		body[8][7][8]=addBPoint(0.5,0.875,1.0,h0);

		body[0][8][0]=addBPoint(-0.29,0.856,0.0,h0);
		body[1][8][0]=addBPoint(-0.217,0.856,0.0,h0);
		body[2][8][0]=addBPoint(-0.145,0.856,0.0,h0);
		body[3][8][0]=addBPoint(-0.073,0.856,0.0,h0);
		body[4][8][0]=addBPoint(0.0,0.856,0.0,h0);
		body[5][8][0]=addBPoint(0.073,0.856,0.0,h0);
		body[6][8][0]=addBPoint(0.145,0.856,0.0,h0);
		body[7][8][0]=addBPoint(0.217,0.856,0.0,h0);
		body[8][8][0]=addBPoint(0.29,0.856,0.0,h0);
		body[0][8][1]=addBPoint(-0.247,0.83,0.248,h0);
		body[1][8][1]=addBPoint(-0.185,0.83,0.248,h0);
		body[2][8][1]=addBPoint(-0.123,0.83,0.248,h0);
		body[3][8][1]=addBPoint(-0.062,0.83,0.248,h0);
		body[4][8][1]=addBPoint(0.0,0.83,0.248,h0);
		body[5][8][1]=addBPoint(0.062,0.83,0.248,h0);
		body[6][8][1]=addBPoint(0.123,0.83,0.248,h0);
		body[7][8][1]=addBPoint(0.185,0.83,0.248,h0);
		body[8][8][1]=addBPoint(0.247,0.83,0.248,h0);
		body[0][8][2]=addBPoint(-0.228,0.816,0.416,h0);
		body[1][8][2]=addBPoint(-0.171,0.816,0.416,h0);
		body[2][8][2]=addBPoint(-0.114,0.816,0.416,h0);
		body[3][8][2]=addBPoint(-0.057,0.816,0.416,h0);
		body[4][8][2]=addBPoint(0.0,0.816,0.416,h0);
		body[5][8][2]=addBPoint(0.057,0.816,0.416,h0);
		body[6][8][2]=addBPoint(0.114,0.816,0.416,h0);
		body[7][8][2]=addBPoint(0.171,0.816,0.416,h0);
		body[8][8][2]=addBPoint(0.228,0.816,0.416,h0);
		body[0][8][3]=addBPoint(-0.216,0.812,0.478,h0);
		body[1][8][3]=addBPoint(-0.162,0.812,0.478,h0);
		body[2][8][3]=addBPoint(-0.108,0.812,0.478,h0);
		body[3][8][3]=addBPoint(-0.054,0.812,0.478,h0);
		body[4][8][3]=addBPoint(0.0,0.812,0.478,h0);
		body[5][8][3]=addBPoint(0.054,0.812,0.478,h0);
		body[6][8][3]=addBPoint(0.108,0.812,0.478,h0);
		body[7][8][3]=addBPoint(0.162,0.812,0.478,h0);
		body[8][8][3]=addBPoint(0.216,0.812,0.478,h0);
		body[0][8][4]=addBPoint(-0.302,0.884,0.565,h0);
		body[1][8][4]=addBPoint(-0.226,0.884,0.565,h0);
		body[2][8][4]=addBPoint(-0.151,0.884,0.565,h0);
		body[3][8][4]=addBPoint(-0.076,0.884,0.565,h0);
		body[4][8][4]=addBPoint(0.0,0.884,0.565,h0);
		body[5][8][4]=addBPoint(0.076,0.884,0.565,h0);
		body[6][8][4]=addBPoint(0.151,0.884,0.565,h0);
		body[7][8][4]=addBPoint(0.226,0.884,0.565,h0);
		body[8][8][4]=addBPoint(0.302,0.884,0.565,h0);
		body[0][8][5]=addBPoint(-0.401,0.935,0.671,h0);
		body[1][8][5]=addBPoint(-0.301,0.935,0.671,h0);
		body[2][8][5]=addBPoint(-0.2,0.935,0.671,h0);
		body[3][8][5]=addBPoint(-0.1,0.935,0.671,h0);
		body[4][8][5]=addBPoint(0.0,0.935,0.671,h0);
		body[5][8][5]=addBPoint(0.1,0.935,0.671,h0);
		body[6][8][5]=addBPoint(0.2,0.935,0.671,h0);
		body[7][8][5]=addBPoint(0.301,0.935,0.671,h0);
		body[8][8][5]=addBPoint(0.401,0.935,0.671,h0);
		body[0][8][6]=addBPoint(-0.451,0.96,0.783,h0);
		body[1][8][6]=addBPoint(-0.338,0.96,0.783,h0);
		body[2][8][6]=addBPoint(-0.225,0.96,0.783,h0);
		body[3][8][6]=addBPoint(-0.113,0.96,0.783,h0);
		body[4][8][6]=addBPoint(0.0,0.96,0.783,h0);
		body[5][8][6]=addBPoint(0.113,0.96,0.783,h0);
		body[6][8][6]=addBPoint(0.225,0.96,0.783,h0);
		body[7][8][6]=addBPoint(0.338,0.96,0.783,h0);
		body[8][8][6]=addBPoint(0.451,0.96,0.783,h0);
		body[0][8][7]=addBPoint(-0.481,0.975,0.907,h0);
		body[1][8][7]=addBPoint(-0.361,0.975,0.907,h0);
		body[2][8][7]=addBPoint(-0.24,0.975,0.907,h0);
		body[3][8][7]=addBPoint(-0.12,0.975,0.907,h0);
		body[4][8][7]=addBPoint(0.0,0.975,0.907,h0);
		body[5][8][7]=addBPoint(0.12,0.975,0.907,h0);
		body[6][8][7]=addBPoint(0.24,0.975,0.907,h0);
		body[7][8][7]=addBPoint(0.361,0.975,0.907,h0);
		body[8][8][7]=addBPoint(0.481,0.975,0.907,h0);
		body[0][8][8]=addBPoint(-0.5,1.0,1.0,h0);
		body[1][8][8]=addBPoint(-0.375,1.0,1.0,h0);
		body[2][8][8]=addBPoint(-0.25,1.0,1.0,h0);
		body[3][8][8]=addBPoint(-0.125,1.0,1.0,h0);
		body[4][8][8]=addBPoint(0.0,1.0,1.0,h0);
		body[5][8][8]=addBPoint(0.125,1.0,1.0,h0);
		body[6][8][8]=addBPoint(0.25,1.0,1.0,h0);
		body[7][8][8]=addBPoint(0.375,1.0,1.0,h0);
		body[8][8][8]=addBPoint(0.5,1.0,1.0,h0);
