...
public class Car extends CustomData {
	...
	private PolygonMesh buildCarMesh() {
		...
		p[0][0][0]=addBPoint(-0.5,0.05,0,p0);
		p[1][0][0]=addBPoint(-0.25,0.0,0,p0);
		p[2][0][0]=addBPoint(0,0.0,0,p0);
		p[3][0][0]=addBPoint(0.25,0.0,0,p0);
		p[4][0][0]=addBPoint(0.5,0.05,0,p0);
		p[0][0][1]=addBPoint(-0.5,0.05,0.5,p0);	
		p[1][0][1]=addBPoint(-0.25,0.0,0.5,p0);	
		p[2][0][1]=addBPoint(0,0.0,0.5,p0);	
		p[3][0][1]=addBPoint(0.25,0.0,0.5,p0);	
		p[4][0][1]=addBPoint(0.5,0.05,0.5,p0);	
		p[0][0][2]=addBPoint(-0.5,0.05,1.0,p0);	
		p[1][0][2]=addBPoint(-0.25,0.0,1.0,p0);	
		p[2][0][2]=addBPoint(0,0.0,1.0,p0);	
		p[3][0][2]=addBPoint(0.25,0.0,1.0,p0);	
		p[4][0][2]=addBPoint(0.5,0.05,1.0,p0);	
		
		p[0][1][0]=addBPoint(-0.5,0.25,0,p0);	
		p[1][1][0]=addBPoint(-0.25,0.25,0,p0);
		p[2][1][0]=addBPoint(0,0.25,0,p0);
		p[3][1][0]=addBPoint(0.25,0.25,0,p0);
		p[4][1][0]=addBPoint(0.5,0.25,0,p0);		
		p[0][1][1]=addBPoint(-0.5,0.25,0.5,p0);
		p[1][1][1]=addBPoint(-0.25,0.25,0.5,p0);
		p[2][1][1]=addBPoint(0,0.25,0.5,p0);
		p[3][1][1]=addBPoint(0.25,0.25,0.5,p0);
		p[4][1][1]=addBPoint(0.5,0.25,0.5,p0);
		p[0][1][2]=addBPoint(-0.5,0.25,1.0,p0);
		p[1][1][2]=addBPoint(-0.25,0.25,1.0,p0);
		p[2][1][2]=addBPoint(0,0.25,1.0,p0);
		p[3][1][2]=addBPoint(0.25,0.25,1.0,p0);
		p[4][1][2]=addBPoint(0.5,0.25,1.0,p0);
		
		
		p[0][2][0]=addBPoint(-0.5,0.5,0,p0);	
		p[1][2][0]=addBPoint(-0.25,0.5,0,p0);
		p[2][2][0]=addBPoint(0,0.5,0,p0);
		p[3][2][0]=addBPoint(0.25,0.5,0,p0);
		p[4][2][0]=addBPoint(0.5,0.5,0,p0);		
		p[0][2][1]=addBPoint(-0.5,0.5,0.5,p0);
		p[1][2][1]=addBPoint(-0.25,0.5,0.5,p0);
		p[2][2][1]=addBPoint(0,0.5,0.5,p0);
		p[3][2][1]=addBPoint(0.25,0.5,0.5,p0);
		p[4][2][1]=addBPoint(0.5,0.5,0.5,p0);
		p[0][2][2]=addBPoint(-0.5,0.5,1.0,p0);
		p[1][2][2]=addBPoint(-0.25,0.5,1.0,p0);
		p[2][2][2]=addBPoint(0,0.5,1.0,p0);
		p[3][2][2]=addBPoint(0.25,0.5,1.0,p0);
		p[4][2][2]=addBPoint(0.5,0.5,1.0,p0);
		
		p[0][3][0]=addBPoint(-0.5,0.75,0,p0);	
		p[1][3][0]=addBPoint(-0.25,0.75,0,p0);
		p[2][3][0]=addBPoint(0,0.75,0,p0);
		p[3][3][0]=addBPoint(0.25,0.75,0,p0);
		p[4][3][0]=addBPoint(0.5,0.75,0,p0);		
		p[0][3][1]=addBPoint(-0.5,0.75,0.5,p0);
		p[1][3][1]=addBPoint(-0.25,0.75,0.5,p0);
		p[2][3][1]=addBPoint(0,0.75,0.5,p0);
		p[3][3][1]=addBPoint(0.25,0.75,0.5,p0);
		p[4][3][1]=addBPoint(0.5,0.75,0.5,p0);
		p[0][3][2]=addBPoint(-0.5,0.75,1.0,p0);
		p[1][3][2]=addBPoint(-0.25,0.75,1.0,p0);
		p[2][3][2]=addBPoint(0,0.75,1.0,p0);
		p[3][3][2]=addBPoint(0.25,0.75,1.0,p0);
		p[4][3][2]=addBPoint(0.5,0.75,1.0,p0);
		
		
		p[0][4][0]=addBPoint(-0.5,0.995,0,p0);	
		p[1][4][0]=addBPoint(-0.25,1.0,0,p0);
		p[2][4][0]=addBPoint(0,1.0,0,p0);
		p[3][4][0]=addBPoint(0.25,1.0,0,p0);
		p[4][4][0]=addBPoint(0.5,0.995,0,p0);		
		p[0][4][1]=addBPoint(-0.5,0.995,0.5,p0);
		p[1][4][1]=addBPoint(-0.25,1.0,0.5,p0);
		p[2][4][1]=addBPoint(0,1.0,0.5,p0);
		p[3][4][1]=addBPoint(0.25,1.0,0.5,p0);
		p[4][4][1]=addBPoint(0.5,0.995,0.5,p0);
		p[0][4][2]=addBPoint(-0.5,0.995,1.0,p0);
		p[1][4][2]=addBPoint(-0.25,1.0,1.0,p0);
		p[2][4][2]=addBPoint(0,1.0,1.0,p0);
		p[3][4][2]=addBPoint(0.25,1.0,1.0,p0);
		p[4][4][2]=addBPoint(0.5,0.995,1.0,p0);
		...
		BPoint[][][] pBack=new BPoint[pnx][bny][pnz];
		...
		pBack[2][0][0]=addBPoint(0.0,0,0,b0);
		...
		pBack[0][0][2]=addBPoint(-0.5,0.1,0.9,b0);
		pBack[1][0][2]=addBPoint(-0.25,0,1.0,b0);
		pBack[2][0][2]=addBPoint(0.0,0,1.0,b0);
		pBack[3][0][2]=addBPoint(0.25,0,1.0,b0);
		pBack[4][0][2]=addBPoint(0.5,0.1,0.9,b0);
		
		pBack[0][1][0]=addBPoint(-0.5,0.5,0,b1);
		pBack[1][1][0]=addBPoint(-0.25,0.5,0,b1);
		pBack[2][1][0]=addBPoint(0.0,0.5,0,b1);	
		pBack[3][1][0]=addBPoint(0.25,0.5,0,b1);	
		pBack[4][1][0]=addBPoint(0.5,0.5,0,b1);	
		pBack[0][1][1]=addBPoint(-0.5,0.5,0.5,b1);
		pBack[1][1][1]=addBPoint(-0.25,0.5,0.5,b1);
		pBack[2][1][1]=addBPoint(0.0,0.5,0.5,b1);	
		pBack[3][1][1]=addBPoint(0.25,0.5,0.5,b1);	
		pBack[4][1][1]=addBPoint(0.5,0.5,0.5,b1);	
		pBack[0][1][2]=addBPoint(-0.5,0.5,0.9,b1);
		pBack[1][1][2]=addBPoint(-0.25,0.5,1.0,b1);
		pBack[2][1][2]=addBPoint(0.0,0.5,1.0,b1);
		pBack[3][1][2]=addBPoint(0.25,0.5,1.0,b1);
		pBack[4][1][2]=addBPoint(0.5,0.5,0.9,b1);
		...
		for(int i=0;i<pnx-1;i++){
			...
			for (int k = 0; k < pnz-1; k++) {
				...
				if(i==0){
					...
					LineData backLeft=addLine(pBack[i][bny-1][k],pBack[i][bny-1][k+1],p[0][0][k+1],p[0][0][k],Renderer3D.CAR_LEFT);

				}
				
				if(i+1==pnx-1){

					LineData backRight=addLine(pBack[i+1][bny-1][k+1],pBack[i+1][bny-1][k],p[i+1][0][k],p[i+1][0][k+1],Renderer3D.CAR_RIGHT);
				}
			
				if(k==0){
					LineData backBottom=addLine(pBack[i+1][bny-1][k],pBack[i][bny-1][k],p[i][0][k],p[i+1][0][k],Renderer3D.CAR_BOTTOM);
				}
				
				if(k+1==pnz-1){
					LineData backTop=addLine(pBack[i][bny-1][k+1],pBack[i+1][bny-1][k+1],p[i+1][0][k+1],p[i][0][k+1],Renderer3D.CAR_TOP);
				}
		...
		for(int i=0;i<pnx-1;i++){
			...
			for (int j = 0; j < bny-1; j++) {	
				...
				for (int k = 0; k < pnz-1; k++) {
					...
					if(i==0)
						addLine(pBack[i][j][k],pBack[i][j][k+1],pBack[i][j+1][k+1],pBack[i][j+1][k],Renderer3D.CAR_LEFT);

					if(j==0){
						LineData backMask=addLine(pBack[i][j][k],pBack[i+1][j][k],pBack[i+1][j][k+1],pBack[i][j][k+1],Renderer3D.CAR_BACK);	
					}				
					
					if(k==0){
						addLine(pBack[i+1][j][k],pBack[i][j][k],pBack[i][j+1][k],pBack[i+1][j+1][k],Renderer3D.CAR_BOTTOM);					
					}
					if(k+1==pnz-1){
						addLine(pBack[i][j][k+1],pBack[i+1][j][k+1],pBack[i+1][j+1][k+1],pBack[i][j+1][k+1],Renderer3D.CAR_TOP);
					}
					...
					if(i+1==pnx-1){
						...
						addLine(pBack[i+1][j][k],pBack[i+1][j+1][k],pBack[i+1][j+1][k+1],pBack[i+1][j][k+1],Renderer3D.CAR_RIGHT);
		...
		BPoint[][][] pFront=new BPoint[pnx][fny][pnz];
		...
		pFront[0][0][1]=addBPoint(-0.5,0.4,0.5,f0);
		pFront[1][0][1]=addBPoint(-0.25,0.5,0.5,f0);
		pFront[2][0][1]=addBPoint(0,0.5,0.5,f0);
		pFront[3][0][1]=addBPoint(0.25,0.5,0.5,f0);
		pFront[4][0][1]=addBPoint(0.5,0.4,0.5,f0);
		pFront[0][0][2]=addBPoint(-0.5,0.4,0.9,f0);
		pFront[1][0][2]=addBPoint(-0.25,0.5,1.0,f0);
		pFront[2][0][2]=addBPoint(0.0,0.5,1.0,f0);
		pFront[3][0][2]=addBPoint(0.25,0.5,1.0,f0);
		pFront[4][0][2]=addBPoint(0.5,0.4,0.9,f0);
		...
		pFront[0][1][1]=addBPoint(-0.5,0.9,0.5,f1);
		pFront[1][1][1]=addBPoint(-0.25,1.0,0.5,f1);
		pFront[2][1][1]=addBPoint(0.0,1.0,0.5,f1);
		pFront[3][1][1]=addBPoint(0.25,1.0,0.5,f1);
		pFront[4][1][1]=addBPoint(0.5,0.9,0.5,f1);	
		pFront[0][1][2]=addBPoint(-0.5,0.9,0.9,f1);
		pFront[1][1][2]=addBPoint(-0.25,1.0,1.0,f1);
		pFront[2][1][2]=addBPoint(0.0,1.0,1.0,f1);
		pFront[3][1][2]=addBPoint(0.25,1.0,1.0,f1);
		pFront[4][1][2]=addBPoint(0.5,0.9,0.9,f1);
		...
		for(int i=0;i<pnx-1;i++){
			...
			for (int k = 0; k < pnz-1; k++) {
				...
				if(i==0){
					...
					LineData frontLeft=addLine(p[0][pny-1][k],p[0][pny-1][k+1],pFront[0][0][k+1],pFront[0][0][k],Renderer3D.CAR_LEFT);
				}				

					
				if(k==0){
					LineData frontBottom=addLine(p[i+1][pny-1][k],p[i][pny-1][k],pFront[i][0][k],pFront[i+1][0][k],Renderer3D.CAR_BOTTOM);
				}
				
				if(k+1==pnz-1){
					LineData frontTop=addLine(p[i][pny-1][k+1],p[i+1][pny-1][k+1],pFront[i+1][0][k+1],pFront[i][0][k+1],Renderer3D.CAR_TOP);
				}
				...
				if(i+1==pnx-1){
					...
					LineData frontRight=addLine(p[i+1][pny-1][k+1],p[i+1][pny-1][k],pFront[i+1][0][k],pFront[i+1][0][k+1],Renderer3D.CAR_RIGHT);
				}
			...
			for (int j = 0; j < fny-1; j++) {
				...
				for (int k = 0; k < pnz-1; k++) {
					...
					if(i==0){
						...
						addLine(pFront[i][j][k],pFront[i][j][k+1],pFront[i][j+1][k+1],pFront[i][j+1][k],Renderer3D.CAR_LEFT);
					}

					if(j+1==fny-1){

						LineData frontMask=addLine(pFront[i][j+1][k],pFront[i][j+1][k+1],pFront[i+1][j+1][k+1],pFront[i+1][j+1][k],Renderer3D.CAR_FRONT);	
						
					}
					
					
					if(k+1==pnz-1){
						addLine(pFront[i][j][k+1],pFront[i+1][j][k+1],pFront[i+1][j+1][k+1],pFront[i][j+1][k+1],Renderer3D.CAR_TOP);
					}
					
					if(k==0)
						addLine(pFront[i+1][j][k],pFront[i][j][k],pFront[i][j+1][k],pFront[i+1][j+1][k],Renderer3D.CAR_BOTTOM);

					

					if(i+1==pnx-1){

						addLine(pFront[i+1][j][k],pFront[i+1][j+1][k],pFront[i+1][j+1][k+1],pFront[i+1][j][k+1],Renderer3D.CAR_RIGHT);
					}
				}
			}
		...
		pr[0][0][0]=addBPoint(-0.5,0.0,0.75,r0);	
		pr[1][0][0]=addBPoint(-0.25,0.0,0.75,r0);	
		pr[2][0][0]=addBPoint(0.0,0.0,0.75,r0);	
		pr[3][0][0]=addBPoint(0.25,0.0,0.75,r0);	
		pr[4][0][0]=addBPoint(0.5,0.0,0.75,r0);
		
		pr[0][1][0]=addBPoint(-0.5,0.25,0.75,r0);	
		pr[1][1][0]=addBPoint(-0.25,0.25,0.75,r0);	
		pr[2][1][0]=addBPoint(-0.0,0.25,0.75,r0);	
		pr[3][1][0]=addBPoint(0.25,0.25,0.75,r0);	
		pr[4][1][0]=addBPoint(0.5,0.25,0.75,r0);
		
		pr[0][2][0]=addBPoint(-0.5,0.5,0.75,r0);	
		pr[1][2][0]=addBPoint(-0.25,0.5,0.75,r0);	
		pr[2][2][0]=addBPoint(0.0,0.5,0.75,r0);	
		pr[3][2][0]=addBPoint(0.25,0.5,0.75,r0);	
		pr[4][2][0]=addBPoint(0.5,0.5,0.75,r0);
		
		pr[0][3][0]=addBPoint(-0.5,0.75,0.75,r0);	
		pr[1][3][0]=addBPoint(-0.25,0.75,0.75,r0);	
		pr[2][3][0]=addBPoint(0.0,0.75,0.75,r0);	
		pr[3][3][0]=addBPoint(0.25,0.75,0.75,r0);	
		pr[4][3][0]=addBPoint(0.5,0.75,0.75,r0);
		
		pr[0][4][0]=addBPoint(-0.5,1.0,0.75,r0);	
		pr[1][4][0]=addBPoint(-0.25,1.0,0.75,r0);	
		pr[2][4][0]=addBPoint(0.0,1.0,0.75,r0);	
		pr[3][4][0]=addBPoint(0.25,1.0,0.75,r0);	
		pr[4][4][0]=addBPoint(0.5,1.0,0.75,r0);
		
		
		pr[0][0][1]=addBPoint(-0.5,0.0,0.9,r0);	
		pr[1][0][1]=addBPoint(-0.25,0.0,1.0,r0);	
		pr[2][0][1]=addBPoint(0.0,0.0,1.0,r0);	
		pr[3][0][1]=addBPoint(0.25,0.0,1.0,r0);	
		pr[4][0][1]=addBPoint(0.5,0.0,0.9,r0);
		
		pr[0][1][1]=addBPoint(-0.5,0.25,0.9,r0);	
		pr[1][1][1]=addBPoint(-0.25,0.25,1.0,r0);	
		pr[2][1][1]=addBPoint(-0.0,0.25,1.0,r0);	
		pr[3][1][1]=addBPoint(0.25,0.25,1.0,r0);	
		pr[4][1][1]=addBPoint(0.5,0.25,0.9,r0);
		
		pr[0][2][1]=addBPoint(-0.5,0.5,0.9,r0);	
		pr[1][2][1]=addBPoint(-0.25,0.5,1.0,r0);	
		pr[2][2][1]=addBPoint(0.0,0.5,1.0,r0);	
		pr[3][2][1]=addBPoint(0.25,0.5,1.0,r0);	
		pr[4][2][1]=addBPoint(0.5,0.5,0.9,r0);
		
		pr[0][3][1]=addBPoint(-0.5,0.75,0.9,r0);	
		pr[1][3][1]=addBPoint(-0.25,0.75,1.0,r0);	
		pr[2][3][1]=addBPoint(0.0,0.75,1.0,r0);	
		pr[3][3][1]=addBPoint(0.25,0.75,1.0,r0);	
		pr[4][3][1]=addBPoint(0.5,0.75,0.9,r0);
		
		pr[0][4][1]=addBPoint(-0.5,1.0,0.9,r0);	
		pr[1][4][1]=addBPoint(-0.25,1.0,1.0,r0);	
		pr[2][4][1]=addBPoint(0.0,1.0,1.0,r0);	
		pr[3][4][1]=addBPoint(0.25,1.0,1.0,r0);	
		pr[4][4][1]=addBPoint(0.5,1.0,0.9,r0);
		...
		for (int i = 0; i < pnx-1; i++) {
			...
			for (int j = 0; j < pny-1; j++) {
					...
					if(i==0){
						...
						LineData leftRLD=addLine(pr[i][j+1][0],p[i][j+1][pnz-1],p[i][j][pnz-1],pr[i][j][0],Renderer3D.CAR_LEFT);

					}

					if(j==0){
						LineData backRLD=addLine(p[i][j][pnz-1],p[i+1][j][pnz-1],pr[i+1][j][0],pr[i][j][0],Renderer3D.CAR_BACK);
					}
					
						
					if(j+1==pny-1){

						LineData frontRLD=addLine(p[i][j+1][pnz-1],pr[i][j+1][0],pr[i+1][j+1][0],p[i+1][j+1][pnz-1],Renderer3D.CAR_FRONT);	
					}


					if(i+1==pnx-1){

						LineData rightRLD=addLine(p[i+1][j][pnz-1],p[i+1][j+1][pnz-1],pr[i+1][j+1][0],pr[i+1][j][0],Renderer3D.CAR_RIGHT);
	...
	private PolygonMesh buildTruckMesh() {
		...
		pFront[0][1][0]=addBPoint(-0.5,0.25,0,f0);
		pFront[1][1][0]=addBPoint(-0.25,0.25,0,f0);
		pFront[2][1][0]=addBPoint(0.0,0.25,0,f0);
		pFront[3][1][0]=addBPoint(0.25,0.25,0,f0);
		pFront[4][1][0]=addBPoint(0.5,0.25,0,f0);
		pFront[0][2][0]=addBPoint(-0.5,0.5,0,f0);
		pFront[1][2][0]=addBPoint(-0.25,0.5,0,f0);
		pFront[2][2][0]=addBPoint(0.0,0.5,0,f0);
		pFront[3][2][0]=addBPoint(0.25,0.5,0,f0);
		pFront[4][2][0]=addBPoint(0.5,0.5,0,f0);
		pFront[0][3][0]=addBPoint(-0.5,0.75,0,f0);
		pFront[1][3][0]=addBPoint(-0.25,0.75,0,f0);
		...
		pFront[0][0][1]=addBPoint(-0.5,0.0,0.5,f0);	
		pFront[1][0][1]=addBPoint(-0.25,0.0,0.5,f0);	
		pFront[2][0][1]=addBPoint(0.0,0.0,0.5,f0);
		pFront[3][0][1]=addBPoint(0.25,0.0,0.5,f0);
		pFront[4][0][1]=addBPoint(0.5,0.0,0.5,f0);	
		pFront[0][1][1]=addBPoint(-0.5,0.25,0.5,f0);
		pFront[1][1][1]=addBPoint(-0.25,0.25,0.5,f0);	
		pFront[2][1][1]=addBPoint(0.0,0.25,0.5,f0);
		pFront[3][1][1]=addBPoint(0.25,0.25,0.5,f0);
		pFront[4][1][1]=addBPoint(0.5,0.25,0.5,f0);
		pFront[0][2][1]=addBPoint(-0.5,0.5,0.5,f0);
		pFront[1][2][1]=addBPoint(-0.25,0.5,0.5,f0);	
		pFront[2][2][1]=addBPoint(0.0,0.5,0.5,f0);
		pFront[3][2][1]=addBPoint(0.25,0.5,0.5,f0);
		pFront[4][2][1]=addBPoint(0.5,0.5,0.5,f0);
		pFront[0][3][1]=addBPoint(-0.5,0.75,0.5,f0);
		pFront[1][3][1]=addBPoint(-0.25,0.75,0.5,f0);	
		pFront[2][3][1]=addBPoint(0.0,0.75,0.5,f0);
		pFront[3][3][1]=addBPoint(0.25,0.75,0.5,f0);
		pFront[4][3][1]=addBPoint(0.5,0.75,0.5,f0);
		pFront[0][4][1]=addBPoint(-0.5,0.9,0.5,f0);	
		pFront[1][4][1]=addBPoint(-0.25,1.0,0.5,f0);
		pFront[2][4][1]=addBPoint(0.0,1.0,0.5,f0);
		pFront[3][4][1]=addBPoint(0.25,1.0,0.5,f0);
		pFront[4][4][1]=addBPoint(0.5,0.9,0.5,f0);
		
		
		pFront[0][0][2]=addBPoint(-0.5,0.0,1.0,f0);	
		pFront[1][0][2]=addBPoint(-0.25,0.0,1.0,f0);	
		pFront[2][0][2]=addBPoint(0.0,0.0,1.0,f0);
		pFront[3][0][2]=addBPoint(0.25,0.0,1.0,f0);
		pFront[4][0][2]=addBPoint(0.5,0.0,1.0,f0);	
		pFront[0][1][2]=addBPoint(-0.5,0.25,1.0,f0);
		pFront[1][1][2]=addBPoint(-0.25,0.25,1.0,f0);	
		pFront[2][1][2]=addBPoint(0.0,0.25,1.0,f0);
		pFront[3][1][2]=addBPoint(0.25,0.25,1.0,f0);
		pFront[4][1][2]=addBPoint(0.5,0.25,1.0,f0);
		pFront[0][2][2]=addBPoint(-0.5,0.5,1.0,f0);
		pFront[1][2][2]=addBPoint(-0.25,0.5,1.0,f0);	
		pFront[2][2][2]=addBPoint(0.0,0.5,1.0,f0);
		pFront[3][2][2]=addBPoint(0.25,0.5,1.0,f0);
		pFront[4][2][2]=addBPoint(0.5,0.5,1.0,f0);
		pFront[0][3][2]=addBPoint(-0.5,0.75,1.0,f0);
		pFront[1][3][2]=addBPoint(-0.25,0.75,1.0,f0);	
		pFront[2][3][2]=addBPoint(0.0,0.75,1.0,f0);
		pFront[3][3][2]=addBPoint(0.25,0.75,1.0,f0);
		pFront[4][3][2]=addBPoint(0.5,0.75,1.0,f0);
		pFront[0][4][2]=addBPoint(-0.5,0.9,1.0,f0);	
		pFront[1][4][2]=addBPoint(-0.25,1.0,1.0,f0);
		pFront[2][4][2]=addBPoint(0.0,1.0,1.0,f0);
		pFront[3][4][2]=addBPoint(0.25,1.0,1.0,f0);
		pFront[4][4][2]=addBPoint(0.5,0.9,1.0,f0);
		...
		pRoof[1][1][1]=addBPoint(-0.25,0.25,0.5,r0);	
		pRoof[2][1][1]=addBPoint(0.0,0.25,0.5,r0);
		pRoof[3][1][1]=addBPoint(0.25,0.25,0.5,r0);
		pRoof[4][1][1]=addBPoint(0.5,0.25,0.5,r0);
		pRoof[0][2][1]=addBPoint(-0.5,0.5,0.5,r0);	
		pRoof[1][2][1]=addBPoint(-0.25,0.5,0.5,r0);	
		pRoof[2][2][1]=addBPoint(0.0,0.5,0.5,r0);
		pRoof[3][2][1]=addBPoint(0.25,0.5,0.5,r0);
		pRoof[4][2][1]=addBPoint(0.5,0.5,0.5,r0);
		pRoof[0][3][1]=addBPoint(-0.5,0.75,0.5,r0);	
		pRoof[1][3][1]=addBPoint(-0.25,0.75,0.5,r0);	
		pRoof[2][3][1]=addBPoint(0.0,0.75,0.5,r0);
		pRoof[3][3][1]=addBPoint(0.25,0.75,0.5,r0);
		...
		pBack[3][0][1]=addBPoint(0.25,0,0.5,b0);	
		pBack[4][0][1]=addBPoint(0.5,0.1,0.5,b0);
		pBack[0][1][1]=addBPoint(-0.5,0.25,0.5,b0);	
		pBack[1][1][1]=addBPoint(-0.25,0.25,0.5,b0);
		pBack[2][1][1]=addBPoint(0.0,0.25,0.5,b0);
		pBack[3][1][1]=addBPoint(0.25,0.25,0.5,b0);
		pBack[4][1][1]=addBPoint(0.5,0.25,0.5,b0);
		pBack[0][2][1]=addBPoint(-0.5,0.5,0.5,b0);	
		pBack[1][2][1]=addBPoint(-0.25,0.5,0.5,b0);
		pBack[2][2][1]=addBPoint(0.0,0.5,0.5,b0);
		pBack[3][2][1]=addBPoint(0.25,0.5,0.5,b0);
		pBack[4][2][1]=addBPoint(0.5,0.5,0.5,b0);
		pBack[0][3][1]=addBPoint(-0.5,0.75,0.5,b0);	
		pBack[1][3][1]=addBPoint(-0.25,0.75,0.5,b0);
		pBack[2][3][1]=addBPoint(0.0,0.75,0.5,b0);
		pBack[3][3][1]=addBPoint(0.25,0.75,0.5,b0);
		pBack[4][3][1]=addBPoint(0.5,0.75,0.5,b0);
		pBack[0][4][1]=addBPoint(-0.5,1.0,0.5,b0);
		pBack[1][4][1]=addBPoint(-0.25,1.0,0.5,b0);		
		pBack[2][4][1]=addBPoint(0.0,1.0,0.5,b0);
		pBack[3][4][1]=addBPoint(0.25,1.0,0.5,b0);
		pBack[4][4][1]=addBPoint(0.5,1.0,0.5,b0);
		...
		pBack[0][1][2]=addBPoint(-0.5,0.25,1.0,b0);	
		pBack[1][1][2]=addBPoint(-0.25,0.25,1.0,b0);
		pBack[2][1][2]=addBPoint(0.0,0.25,1.0,b0);
		pBack[3][1][2]=addBPoint(0.25,0.25,1.0,b0);
		pBack[4][1][2]=addBPoint(0.5,0.25,1.0,b0);
		pBack[0][2][2]=addBPoint(-0.5,0.5,1.0,b0);	
		pBack[1][2][2]=addBPoint(-0.25,0.5,1.0,b0);
		pBack[2][2][2]=addBPoint(0.0,0.5,1.0,b0);
		pBack[3][2][2]=addBPoint(0.25,0.5,1.0,b0);
		pBack[4][2][2]=addBPoint(0.5,0.5,1.0,b0);
		pBack[0][3][2]=addBPoint(-0.5,0.75,1.0,b0);	
		pBack[1][3][2]=addBPoint(-0.25,0.75,1.0,b0);
		pBack[2][3][2]=addBPoint(0.0,0.75,1.0,b0);
		pBack[3][3][2]=addBPoint(0.25,0.75,1.0,b0);
		pBack[4][3][2]=addBPoint(0.5,0.75,1.0,b0);
		pBack[0][4][2]=addBPoint(-0.5,1.0,1.0,b0);
		pBack[1][4][2]=addBPoint(-0.25,1.0,1.0,b0);		
		pBack[2][4][2]=addBPoint(0.0,1.0,1.0,b0);
		pBack[3][4][2]=addBPoint(0.25,1.0,1.0,b0);
		pBack[4][4][2]=addBPoint(0.5,1.0,1.0,b0);
