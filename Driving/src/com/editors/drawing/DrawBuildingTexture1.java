...
public class DrawBuildingTexture1 {	
	...
	Color SHUTTER_COLOR=SHUTTER_COLORS[SHUTTER_COLORS_SANDSTONE];
	...
	Color ROOF_COLORO=ROOF_COLORS[ROOF_COLORS_BEIGE];
	Color ROOF_COLOR1=ROOF_COLORS[ROOF_COLORS_COFFEE];
