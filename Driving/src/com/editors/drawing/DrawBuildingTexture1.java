...
public class DrawBuildingTexture1 {	
	...
	Color SHUTTER_COLOR=SHUTTER_COLORS[SHUTTER_COLORS_DARK_BROWN];
	...
	Color FRONT_WALL_COLOR=WALL_COLORS[WALL_COLORS_LIGHT_PINK];
	Color BACK_WALL_COLOR=WALL_COLORS[WALL_COLORS_LIGHT_PINK];
	Color LEFT_WALL_COLOR=WALL_COLORS[WALL_COLORS_LIGHT_PINK];
	Color RIGHT_WAll_COLOR=WALL_COLORS[WALL_COLORS_LIGHT_PINK];
	...
	Color[] ROOF_COLORS={
			...
			new Color(29, 78, 48),
			new Color(56, 150, 91)};
	Color ROOF_COLORO=ROOF_COLORS[ROOF_COLORS_DEEP_GREEN];
	Color ROOF_COLOR1=ROOF_COLORS[ROOF_COLORS_LIGHT_GREEN];
