...
public class Animal extends CustomData{
	...
	public int animal_type=ANIMAL_TYPE_QUADRUPED;


	public Animal(){}

	public Animal( double nw_x, double nw_y,double x_side, double y_side,double z_side,int animal_type
			) {
		super();
	...
	public Object clone(){
		...
		Animal animal=new Animal(nw_x,nw_y,x_side,y_side,z_side,animal_type);
		return animal;
	...
	public String toString() {
		...
		return nw_x+","+nw_y+","+x_side+","+y_side+","+z_side+","+animal_type;
	}
	...
	public static Animal buildPlan(String str) {
		...
		int animal_type =Integer.parseInt(vals[5]);

		Animal grid=new Animal(nw_x,nw_y,x_side,y_side,z_side,animal_type);
